...
Hệ thống SHALL có component `PipeReadingRow.vue` hiển thị 1 pipe row: tên pipe bên trái trên, field name bên trái dưới, water level bên phải, và edit icon nếu pending. Row có divider `border-b border-neutral-200`. Không hardcode hex.
