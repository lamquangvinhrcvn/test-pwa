...
Định nghĩa hệ thống design tokens (màu sắc, typography, spacing) dùng chung cho toàn bộ UG AWD Monitor App. Sử dụng Tailwind v4 `@theme` để Nuxt UI v3 tự động nhận diện.
