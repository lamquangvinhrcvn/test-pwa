...
const fields = ref<FieldsTopField[]>([
  { id: 'A', label: 'A', name: 'Field A', area: 0.8, pipeCount: 2, polygon: [{ x: 20, y: 20 }, { x: 100, y: 20 }, { x: 100, y: 80 }, { x: 20, y: 80 }] },
  { id: 'B', label: 'B', name: 'Field B', area: 0.5, pipeCount: 2, polygon: [{ x: 120, y: 10 }, { x: 190, y: 10 }, { x: 190, y: 60 }, { x: 120, y: 60 }] },
  { id: 'C', label: 'C', name: 'Field C', area: 1.2, pipeCount: 3, polygon: [{ x: 90, y: 90 }, { x: 200, y: 90 }, { x: 200, y: 150 }, { x: 90, y: 150 }] },
])
